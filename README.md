...
Standard (linear) statistics don't work on phase because phase wraps: $1°$ and $359°$ are only $2°$ apart on the circle, but their linear mean is $180°$ — the point diametrically opposite both. The circular mean avoids this by working directly on the circle, correctly landing near $0°$:

<div align="center">
  <img src="linear_circular_mea.jpg" alt="Comparison of linear mean vs. circular mean for phase angles 1°, 0°, and 359°" width="800"/>
</div>

The same issue distorts variance: phase values scattered near the $\pm\pi$ wrap boundary show artificially high linear variance, even when physically tightly clustered. This is an artifact of the arbitrary wrap point, not the underlying physics — which is why circular statistics, built directly on the topology of the circle, are used throughout this repository.
